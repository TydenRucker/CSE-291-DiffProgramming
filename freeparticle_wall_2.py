...
import math
import numpy as np
with open('examples/loma_code/free_particle_Wall_2d.py') as f:
...
config = FreeParticleConfig(mass = m,wall_pos = 5,wall_stiffness=1e5,g=2.0)
...
anim = visualize()
anim.save('particle_rev_wall_2_w_g.mp4')
plt.show()
